...
class ReferentielFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $referentiel->setLibelle("referentiel 1")
            ...
            ->addCrAdmission($this->getReference("CritereAdmission 1"))
            ->addCrEvaluation($this->getReference("CritereEvaluation 1"))
    ...
    {
        return array (CritereAdmissionFixtures::class, CritereEvaluationFixtures::class, CompetenceFixtures::class );
    }
}