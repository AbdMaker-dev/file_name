...
class Brief
{
     ...
     * @Groups({"brief:read", "brief:write", "groupe_briefs:read"})
     * @Assert\NotNull(message = "referentiel du Brief aubligatoire")
     */
    private $referentiel;
     ...
     * @Groups({"brief:read", "brief:write", "groupe_briefs:read"})
     * @Assert\NotNull(message = "les niveaude competences du Brief aubligatoire")
     */
     ...
     * @Groups({"brief:read", "brief:write", "groupe_briefs:read"})
     * @Assert\NotNull(message = "les tags du Brief aubligatoire")
     */
    private $tags;
     ...
     * @Groups({"brief:read", "brief:write", "groupe_briefs:read"})
     * @Assert\NotNull(message = "formateur du Brief aubligatoire")
     */
    private $formateur;
    ...
    /**
     * @ORM\ManyToMany(targetEntity=BriefGroupe::class, inversedBy="briefs")
     */
    private $groupes;
    ...
    public function addGroupe(BriefGroupe $groupe): self
    {
    ...
    public function removeGroupe(BriefGroupe $groupe): self
    {
