...
class Groupe
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=BriefGroupe::class, inversedBy="groupes", cascade={"persist"})
     */
    private $briefs;
    ...
    public function addBrief(BriefGroupe $brief): self
    {
    ...
    public function removeBrief(BriefGroupe $brief): self
    {
