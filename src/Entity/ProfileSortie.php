 ...
 * @UniqueEntity(
 *     fields={"libelle"},
 *     message="libelle de ce  Profile de Sortie existe"
 * )
...
class ProfileSortie
{
     ...
     * @Groups({"profile_sortie:read", "user:read", "promo:read"})
     */
    private $id;
     ...
     * @Groups({"profile_sortie:read", "profile_sortie:write", "user:read", "promo:read"})
     * 
     */
    private $libelle;
     ...
     * @Groups({"profile_sortie:read", "profile_sortie:write", "promo:read"})
     */
