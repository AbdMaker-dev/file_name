...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdminFixtures($b), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ApprenantFixtures($b), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\BriefFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\CmFixtures($b), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\CompetenceFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\CritereAdmissionFixtures(), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\CritereEvaluationFixtures(), 'groups' => []], 8 => ['fixture' => new \App\DataFixtures\EtatBriefFixtures(), 'groups' => []], 9 => ['fixture' => new \App\DataFixtures\FormateurFixtures($b), 'groups' => []], 10 => ['fixture' => new \App\DataFixtures\GroupeCompetenceFixtures(), 'groups' => []], 11 => ['fixture' => new \App\DataFixtures\GroupeFixtures(), 'groups' => []], 12 => ['fixture' => new \App\DataFixtures\GroupeTagFixtures(), 'groups' => []], 13 => ['fixture' => new \App\DataFixtures\LangueFixtures(), 'groups' => []], 14 => ['fixture' => new \App\DataFixtures\LivrableAtenduFixtures(), 'groups' => []], 15 => ['fixture' => new \App\DataFixtures\NiveauFixtures(), 'groups' => []], 16 => ['fixture' => new \App\DataFixtures\ProfileFixtures(), 'groups' => []], 17 => ['fixture' => new \App\DataFixtures\PromoFixtures(), 'groups' => []], 18 => ['fixture' => new \App\DataFixtures\ReferentielFixtures(), 'groups' => []], 19 => ['fixture' => new \App\DataFixtures\RessourceFixtures(), 'groups' => []], 20 => ['fixture' => new \App\DataFixtures\TagFixtures(), 'groups' => []]]);
