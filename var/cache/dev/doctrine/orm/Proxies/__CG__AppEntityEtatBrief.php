 ...
 */
class EtatBrief extends \App\Entity\EtatBrief implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\EtatBrief' . "\0" . 'id', '' . "\0" . 'App\\Entity\\EtatBrief' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\EtatBrief' . "\0" . 'briefs'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EtatBrief $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\EtatBrief
    {
     ...
     * {@inheritDoc}
     */
    public function addBrief(\App\Entity\Brief $brief): \App\Entity\EtatBrief
    {
     ...
     * {@inheritDoc}
     */
    public function removeBrief(\App\Entity\Brief $brief): \App\Entity\EtatBrief
    {
