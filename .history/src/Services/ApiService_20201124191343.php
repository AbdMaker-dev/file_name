...
class ApiService
{
    ...
    public function __construct(F,CompetenceRepository $repo_Competence,ProfileRepository $profile, ProfileRepository $repo_profil, SerializerInterface $serializer, ValidatorInterface $validator, UserPasswordEncoderInterface $encoder)
    {
