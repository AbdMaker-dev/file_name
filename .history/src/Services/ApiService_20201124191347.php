...
class ApiService
{
    ...
    public function __construct(For,CompetenceRepository $repo_Competence,ProfileRepository $profile, ProfileRepository $repo_profil, SerializerInterface $serializer, ValidatorInterface $validator, UserPasswordEncoderInterface $encoder)
    {
