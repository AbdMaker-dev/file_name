...
class UserService
{
    ...
    public function __construct(ProfileRepository $profile, Use, SerializerInterface $serializer, ValidatorInterface $validator, UserPasswordEncoderInterface $encoder)
    {
