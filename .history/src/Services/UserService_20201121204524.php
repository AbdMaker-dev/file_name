...
class UserService
{
    ...
    public function __construct(ProfileRepository $profile, UserRepository $u, SerializerInterface $serializer, ValidatorInterface $validator, UserPasswordEncoderInterface $encoder)
    {
