 ...
 *          "method"="GET",
 *          "path"= "/promo/{id}/groupes/{di}/apprenants",
...
class Promo
{
    ...
    public function setGoupes(array $objects)
    {
    ...
    public function setFormateur(array $objects)
    {
        foreach ($objects as $key => $value) {
    ...
    public function setApprenant(array $objects)
    {
        foreach ($objects as $key => $value) {
            $this->addFormateur($value);
        }
