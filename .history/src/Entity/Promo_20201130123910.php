...
class Promo
{
     ...
     * @Groups({"promo:read", "promo_appre_attente:read"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotNull(message = "titre du promo aubligatoire")
     ...
     * @ORM\Column(type="string", length=255)
     * @Groups({"promo:read", "promo:write", "promo_id_ref:write"})
     * @Assert\NotNull(message = "langue du promo aubligatoire")
     */
    private $langue;

    /**
     * @ORM\Column(type="text")
     * @Assert\NotNull(message = "description du promo aubligatoire")
     * @Groups({"promo:read", "promo:write", "promo_id_ref:write"})
     * 
     */
    private $description;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotNull(message = "lieu du promo aubligatoire")
     * @Groups({"promo:read", "promo:write", "promo_id_ref:write"})
     *
     */
    private $lieu;
     ...
     * @ORM\Column(type="string", length=255)
     * @Groups({"promo:read", "promo:write", "promo_id_ref:write"})
     * @Assert\NotNull(message = "reference Agate du promo aubligatoire")
     * 
     * 
     */
    private $refAgate;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotNull(message = "fabrique Agate du promo aubligatoire")
     * @Groups({"promo:read", "promo:write", "promo_id_ref:write"})
     * 
     */
    private $fabrique;
     ...
     * @Assert\NotNull(message = "date Debut Agate du promo aubligatoire")
     * @Groups({"promo:read"})
     * 
     */
    private $dateDebut;
    ...
    /**
     * @ORM\Column(type="date")
     * @Assert\NotNull(message = "date Fin Agate du promo aubligatoire")
     * @Groups({"promo:read", "promo:write", "promo_id_ref:write"})
     * 
     */
    private $dataFin;
     ...
     * @Groups({"promo:read", "groupe_briefs:read"})
     */
    private $groupes;
    ...
    public function removeApprenant(Apprenant $apprenant): self
    {
        ...
        $apprenant->setDeleted(true);
        // if ($this->apprenants->removeElement($apprenant)) {
        //     // set the owning side to null (unless already changed)
        //     if ($apprenant->getPromo() === $this) {
        //         $apprenant->setPromo(null);

        //         //  suppresion de l'apprenannt dans les groupes du promo
