...
class Competence
{
     ...
     * @Groups({"competence:read", "gp_competence:read", "referentiel:read", "ref_gpc_c:read", "brief:read", "brief:write"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"competence:read", "competence:write", "gp_competence:read", "gp_competence:write", "referentiel:read", "ref_gpc_c:read"})
