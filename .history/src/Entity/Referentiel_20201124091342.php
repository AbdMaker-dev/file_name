...
class Referentiel
{
     ...
     * @Groups({"referentiel:read", "ref_gpc_c:read"})
     */
    private $id;
    ...
    public function setCrCrEvaluation($crCrEvaluations)
    {
        $this->crCrEvaluation = $crCrEvaluations;
        
        foreach ($crCrEvaluations as $key => $crCrEvaluation) {
            $crCrEvaluation->setReferentiel($this);
        }
    }
