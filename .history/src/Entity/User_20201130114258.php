...
class User implements UserInterface
{
     ...
     * @Groups({"user:read", "user:write", "profile_user:read", "profils_id_user:read", "promo:read", "groupe:read""brief:read", "brief:write"})
     */
    protected $username;
     ...
     * @Groups({"user:read", "user:write", "profils_id_user:read", "promo:read", "groupe:read", "brief:read", "brief:write"})
     */
    protected $nom;
     ...
     * @Groups({"user:read", "user:write", "profils_id_user:read", "promo:read", "groupe:read"})
     */
    protected $prenom;
