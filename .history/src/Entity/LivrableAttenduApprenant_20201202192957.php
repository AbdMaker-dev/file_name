...
class LivrableAttenduApprenant
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=LivrableAttendus::class, inversedBy="livrableAttenduApprenants")
     */
    private $livrableAttendus;

    /**
     * @ORM\ManyToMany(targetEntity=Apprenant::class, inversedBy="livrableAttenduApprenants")
     */
    private $apprenants;
