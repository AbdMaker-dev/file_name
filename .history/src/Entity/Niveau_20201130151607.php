...
class Niveau
{
     ...
     * @Groups({"competence:read", ,"niveau:read","niveau:write", "groupe_briefs:read", "referentiel:read", "ref_gpc_c:read", "brief:read"})
     */
    private $id;
     ...
     * @Groups({"competence:read", "niveau:read","niveau:write", "groupe_briefs:read", "competence:write", "gp_competence:write", "referentiel:read", "ref_gpc_c:read"})
     */
