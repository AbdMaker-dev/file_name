 ...
 * @UniqueEntity(
 *     fields={"titre"},
 *     message="titre de ce  Profile existe"
 * )
 */
class Brief
{
     ...
     * @Assert\NotNull(message = "langue du Profile aubligatoire")
     */
    private $langue;
     ...
     * @Groups({"brief:read", "brief:write", "groupe_briefs:read"})
     * @Assert\NotNull(message = "libelle du Profile aubligatoire")@Assert\NotNull(message = "libelle du Profile aubligatoire")
     */
    private $titre;
