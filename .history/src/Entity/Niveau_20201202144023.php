...
class Niveau
{
     ...
     * @Groups({"competence:read", "gp_competence:read", "niveau:read", "groupe_briefs:read", "referentiel:read", "ref_gpc_c:read", "brief:read"})
     */
    private $id;
     ...
     * @Groups({"niveau:write","niveau:read", "gp_competence:read", "niveau:write", "groupe_briefs:read", "competence:read", "competence:write", "gp_competence:write", "referentiel:read", "ref_gpc_c:read", "brief:read", "brief:write"})
     */
    private $libelle;
     ...
     * @Groups({"niveau:write","niveau:read",  "brief:read", "brief:write", "groupe_briefs:read", "competence:read", "competence:write", "gp_competence:write", "referentiel:read", "ref_gpc_c:read"})
