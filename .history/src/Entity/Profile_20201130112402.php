 ...
 * @ApiResource(
 * routePrefix="/admin",
 * attributes={"access_control"="is_granted('ROLE_ADMIN') or is_granted('ROLE_FORMATEUR') or is_granted('ROLE_ADMIN')"},
 * 
...
class Profile
{
     ...
     * @Assert\NotNull(message = "libelle du Profile aubligatoire")
     */
    private $libelle;
