...
class Niveau
{
     ...
     * @Groups({"competence:read", "groupe_briefs:read", "referentiel:read", "ref_gpc_c:read", "brief:read"})
     */
    private $id;
     ...
     * @Groups({"niveau:write","niveau:read","niveau:read" "groupe_briefs:read", "competence:read", "competence:write", "gp_competence:write", "referentiel:read", "ref_gpc_c:read", "brief:read", "brief:write"})
     */
    private $libelle;

    /**
     * @ORM\Column(type="boolean")
     * @Groups({"competence:read", "groupe_briefs:read", "competence:write", "gp_competence:write", "referentiel:read", "ref_gpc_c:read"})
     */
     ...
     * @Groups({"niveau:write", "groupe_briefs:read", "competence:read", "competence:write", "gp_competence:write", "referentiel:read", "ref_gpc_c:read"})
     */
