...
class User implements UserInterface
{
     ...
     * @Groups({"user:read", "groupe_briefs:read", "groupe_briefs:read", "user:write", "profile_user:read", "profils_id_user:read", "promo:read", "groupe:read""brief:read", "brief:write"})
     */
    protected $username;
