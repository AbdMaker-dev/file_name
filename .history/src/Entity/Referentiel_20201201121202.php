 ...
 * @UniqueEntity(
 *     fields={"libelle"},
 *     message="libelle de ce  Referentiel existe"
 * )
 */
class Referentiel
{
     ...
     * @Groups({"referentiel:read", "ref_gpc_c:read", "promo:read","brief:read", "brief:write" "groupe_briefs:read"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotNull(message = "libelle du referentiel aubligatoire")
     * @Groups({"referentiel:read", "groupe_briefs:read", "ref_gpc_c:read", "referentiel:write", "promo:read", "brief:read", "brief:write"})
     */
    private $libelle;

    /**
     * @ORM\Column(type="text")
     * @Assert\NotNull(message = "presentation du referentiel aubligatoire")
     * @Groups({"referentiel:read", "groupe_briefs:read", "ref_gpc_c:read", "referentiel:write", "promo:read", "brief:read", "brief:write"})
     */
     ...
     * @Groups({"referentiel:read", "ref_gpc_c:read", "referentiel:write", "brief:read", "brief:write"})
     */
    private $deleted = false;

    /**
     * @ORM\OneToMany(targetEntity=CritereAdmission::class, mappedBy="referentiel", cascade={"persist"})
     * @Groups({"referentiel:read", "ref_gpc_c:read", "referentiel:write", "promo:read", "brief:read", "brief:write"})
     */
    private $crAdmission;
     ...
     * @Groups({"referentiel:read", "groupe_briefs:read", "ref_gpc_c:read", "referentiel:write", "brief:read", "brief:write"})
     */
    private $competences;
