...
class BriefController extends AbstractController
{
     ...
     */
    public function postBriefs(Request $request, BriefRepository $repo_brief, ApiService $apiService, SerializerInterface $serializer, EntityManagerInterface $em, NiveauRepository $repo_niv, TagsRepository $repo_tag, FormateurRepository $repo_forma, EtatBriefRepository ): Response
    {
