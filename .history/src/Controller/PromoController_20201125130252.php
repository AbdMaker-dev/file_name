...
class PromoController extends AbstractController
{
    ...
    */
     ...
     */
    public function updatePromoIdForm(int $id, Request $req, PromoRepository $repo_promo, FormateurRepository $repo_forma): Response
    {
        ...
        foreach ($data["formateurs"] as $key => $value) {
            if ($value['action']== "remove") {
                $promo->removeFormateur($repo_forma->find($value['action']));
            }else{
                $promo->addFormateur($repo_forma->find())
            }
        }
