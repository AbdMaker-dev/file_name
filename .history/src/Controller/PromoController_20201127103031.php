...
class PromoController extends AbstractController
{
     ...
     */
    public function updatePromoIdGroupdId(int $id, int $di, PromoRepository $repo_promo, GroupeRepository $repo_groupe): Response
    {
    ...
    if (!$promo->getGroupes()->contains($groupe)) {
        return $this->json([
            'message' => 'Ce groupe n\'est pas dans le'
        ]);
    }
