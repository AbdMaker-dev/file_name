...
class UserController extends AbstractController
{
     ...
     */
    public function addApprenant(UserServices $us_serice, Request $request, SerializerInterface $serializer, ValidatorInterface $validator, UserPasswordEncoderInterface): Response
    {
