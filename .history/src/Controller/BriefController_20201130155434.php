...
class BriefController extends AbstractController
{
     ...
     */
    public function postBriefs(Request $request, BriefRepository $repo_brief, ApiService $apiService, SerializerInterface $serializer, EntityManagerInterface $em): Response
    {
        ...
        $data = $apiService->unsetter($data, ["niveauCompetences"]);

        $new_brief = $serializer->denormalize($data[0], "App\Entity\Brief");

        $new_brief = $apiService->assigned($new_brief ,"niveauCompetences", $data[1]["niveauCompetences"], new NiveauRepository());
        dd($new_brief);
