...
class ReferentielController extends AbstractController
{
     ...
     */
    public function addReferentiel(Request $request, Api SerializerInterface $serializer, CompetenceRepository $repo_competence, EntityManagerInterface $em): Response
    {
        // security du route
