...
class BriefController extends AbstractController
{
    ...
    /**
     * @Route("/formateur/{id}/briefs/broullons", name="get_formateur_id_briefs", methods={"GET"})
     */
    public function getFormateurIdBriefsBroullon(int $id, BriefRepository $repo_brief, SerializerInterface $serializer): Response
    {

        $brief = $repo_brief->findOneBy($id);
