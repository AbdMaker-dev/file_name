...
class BriefController extends AbstractController
{
     ...
     */
    public function postBriefs(Request $request, int $id, BriefRepository $repo_brief, SerializerInterface $serializer, EntityManagerInterface $em): Response
    {
        ...
        $avatar = $request->files->get("ressource");
        if ($avatar){
            $avatar = fopen($avatar->getRealPath(), "rb");
            $object["ressource"] = $avatar;
        }
