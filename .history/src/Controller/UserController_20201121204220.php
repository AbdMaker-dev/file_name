...
class UserController extends AbstractController
{
     ...
     */    
    public function updateUser(int $id, UserRepository $user_repo, Request $request, UserService $us_serice, EntityManagerInterface $entityManager)
    {

        dd($user_repo->findOneById($id));
