...
class ReferentielController extends AbstractController
{
     ...
     */
    public function updateReferentiel(int $id, Request $request, Refe ApiService $apiService, SerializerInterface $serializer, CompetenceRepository $repo_competence, EntityManagerInterface $em): Response
    {
        // security du route
        if (in_array("ROLE_APPRENANT", $this->getUser()->getRoles())) {
            return $this->json([
