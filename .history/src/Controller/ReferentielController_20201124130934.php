...
class ReferentielController extends AbstractController
{
    ...
    public function addReferentiel(Request $request, ApiService $apiService, SerializerInterface $serializer, CompetenceRepository $repo_competence, EntityManagerInterface $em): Response
    {
        ...
        /**
     * @Route("/referentiels", name="referentiel_update", methods={"POST"})
     */
    public function updateReferentiel(Request $request, ApiService $apiService, SerializerInterface $serializer, CompetenceRepository $repo_competence, EntityManagerInterface $em): Response
    {
        // security du route
        if (in_array("ROLE_APPRENANT", $this->getUser()->getRoles())) {
            return $this->json([
