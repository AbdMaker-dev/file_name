...
class BriefController extends AbstractController
{
    ...
    /**
     * @Route("/briefs/{di}", name="getPromoIdBriefsId", methods={"GET"})
     */
    public function postBriefsId(int $id, int $di, BriefRepository $repo_brief, SerializerInterface $serializer): Response
    {

        $promo_groups = $repo_brief->findOneByPomoIBriefId($id,$di);
