...
class ReferentielController extends AbstractController
{
     ...
     */
    public function addReferentiel(Request $request, ApiService  SerializerInterface $serializer, CompetenceRepository $repo_competence, EntityManagerInterface $em): Response
    {
        // security du route
