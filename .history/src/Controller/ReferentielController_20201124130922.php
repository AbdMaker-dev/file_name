...
class ReferentielController extends AbstractController
{
     ...
     * @Route("/referentiels", name="referentiel_add", methods={"POST"})
     */
    public function upReferentiel(Request $request, ApiService $apiService, SerializerInterface $serializer, CompetenceRepository $repo_competence, EntityManagerInterface $em): Response
    {
        // security du route
        if (in_array("ROLE_APPRENANT", $this->getUser()->getRoles())) {
            return $this->json([
