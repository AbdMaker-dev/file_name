...
class GrCompetenceController extends AbstractController
{
     ...
     */
    public function updateGroupeComptence(int $id, Request $request, SerializerInterface $serialize, CompetenceRepository $repo_Competence, EntityManagerInterface $em, GroupeCompetenceRepository $repo_grC): Response
    {

        $data_gr_competence = json_decode($request->getContent(),true);
        
        $new_gr_competence = $repo_grC->fond;
