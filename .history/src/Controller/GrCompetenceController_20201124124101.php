...
class GrCompetenceController extends AbstractController
{
     ...
     */
    public function updateGroupeComptence(int Request $request, SerializerInterface $serialize, CompetenceRepository $repo_Competence, EntityManagerInterface $em): Response
    {
