...
class BriefController extends AbstractController
{
     ...
     */
    public function getFormateurIdBriefsBroullon(int $id, BriefRepository $repo_brief, EtatBriefRepository $repo_etet, SerializerInterface $serializer): Response
    {


        $brief = $repo_brief->findByEtatBrief($id);
