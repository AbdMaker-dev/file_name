...
class GrCompetenceController extends AbstractController
{
    ...
    public function addGroupeComptence(Request $request, SerializerInterface $serialize, CompetenceRepository $repo_Competence, EntityManagerInterface $em): Response
    {
        ...
        /**
     * @Route("/groupe_competences", name="update_gr_competence",  methods={"POST"})
     */
    public function updateGroupeComptence(Request $request, SerializerInterface $serialize, CompetenceRepository $repo_Competence, EntityManagerInterface $em): Response
    {
