...
class GrCompetenceController extends AbstractController
{
     ...
     */
    public function updateGroupeComptence(int $id, Request $request, SerializerInterface $serialize, CompetenceRepository $repo_Competence, EntityManagerInterface $em, Gr): Response
    {
