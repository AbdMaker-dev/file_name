...
class BriefController extends AbstractController
{
     ...
     */
    public function postBriefs(Request $request, BriefRepository $repo_brief, ApiService $apiService, SerializerInterface $serializer, EntityManagerInterface $em, NiveauRepository $repo_niv, TagsRepository $repo_tag ): Response
    {
        ...
        $data = $apiService->unsetter($data, ["niveauCompetences", "tags"]);
        ...
        $new_brief = $apiService->assigned($new_brief ,"niveauCompetences", $data[1]["tags"], $repo_tag);
        dd($new_brief);
