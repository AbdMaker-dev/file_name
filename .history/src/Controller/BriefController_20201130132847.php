...
class BriefController extends AbstractController
{
    ...
    /**
     * @Route("/briefs/{di}", name="postBriefs", methods={"POST"})
     */
    public function postBriefs(int $id, BriefRepository $repo_brief, SerializerInterface $serializer, EntityManagerInterface $em): Response
    {
        $brief = $repo_brief->findOneById($id);
