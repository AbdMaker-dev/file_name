...
class PromoController extends AbstractController
{
     ...
     */
    public function addPromo(Request $request, SerializerInterface $serializer, ApiService $apiService, E): Response
    {
        ...
        $new_promo->setGroupes($apiService->creatGroupe($_groupes));
