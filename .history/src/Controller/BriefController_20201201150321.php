...
class BriefController extends AbstractController
{
     ...
     */
    public function getPromoIdBriefsId(int $id, int $di, BriefPromotionsRepository $repo_promo, SerializerInterface $serializer): Response
    {
        $promo_groups = $repo_promo->findOneBySomeField($id,$di);
