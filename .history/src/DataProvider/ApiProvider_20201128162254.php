...
class ApiProvider implements ContextAwareCollectionDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    public function getCollection(string $resourceClass, string $operationName = null, array $context = [])
    {
        ...
        // Gestion des Groupes competences    
        if ($resourceClass == "App\Entity\GroupeCompetence" || $resourceClass == "App\Entity\Referentiel") {
        ...
        if ($resourceClass == "App\Entity\User") {
         ...
         // Gestion des apprenat en attente des promo
        if ($operationName == "promo_appre_attente") {
            $queryBuilder->join("o.apprenants", "a")
                ->addSelect("a")
                ->andWhere('a.attente = :val2')
                ->setParameter('val2', tru);
        }
