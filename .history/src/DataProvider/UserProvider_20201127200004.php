...
class UserProvider implements ContextAwareCollectionDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    public function __construct(ManagerRegistry $managerRegistry, PaginationExtension $, iterable $itemExtensions,ProfileRepository $repo_profil , UserRepository $repo)
    {
