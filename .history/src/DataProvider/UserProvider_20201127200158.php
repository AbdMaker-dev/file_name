...
class UserProvider implements ContextAwareCollectionDataProviderInterface, RestrictedDataProviderInterface
{
    ...
    public function __construct(ManagerRegistry $managerRegistry, Pagina $pagi, iterable $itemExtensions,ProfileRepository $repo_profil , UserRepository $repo)
    {
    ...
    public function getCollection(string $resourceClass, string $operationName = null, array $context = [])
    {
        ...
        return $this->pagi->getResult($collection, $resourceClass, $operationName, $context);
