...
class BriefFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {
        return array (LangueFixtures::class,EtatBriefFixtures::class, ReferentielFixtures::class, NiveauFixtures::class, TagFixtures::class,ReferentielFixtures::class, GroupeFixtures::class, ApprenantFixtures::class, FormateurFixtures::class);
    }
}