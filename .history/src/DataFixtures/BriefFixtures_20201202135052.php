...
class BriefFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {
        return array (LangueFixtures::class, EtatBriefFixtures::class, ReferentielFixtures::class, NiveauFixtures::class, TagFixtures::class,ReferentielFixtures::class, GroupeFixtures::class, Pr::class, FormateurFixtures::class);
    }
}