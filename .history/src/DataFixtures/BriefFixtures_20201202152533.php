...
class BriefFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {
        return array (LangueFixtures::class,Ress, EtatBriefFixtures::class, ReferentielFixtures::class, NiveauFixtures::class, TagFixtures::class, FormateurFixtures::class, GroupeFixtures::class);
    }
}