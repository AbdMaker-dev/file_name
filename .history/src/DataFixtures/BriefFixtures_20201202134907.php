...
class BriefFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    {
        return array (LangueFixtures::class,ReferentielFixtures::class, NiveauFixtures,ReferentielFixtures::class, GroupeFixtures::class, ApprenantFixtures::class, FormateurFixtures::class);
    }
}